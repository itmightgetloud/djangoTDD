...
class SendLoginEmailViewTest(TestCase):
	...
	def test_sends_mail_to_address_from_post(self):
		...
		self.assertEqual(self.subject, 'Your login link for Todo app')
		self.assertEqual(self.from_email, 'noreply@todoapp')
		self.assertEqual(self.to_list, ['a@example.com'])
	"""
	#same behaviour as test above using Mock from unittest
	...
	def test_sends_mail_to_address_from_post(self, mock_send_mail):
		...
		self.assertEqual(subject, 'Your login link for Todo app')
		self.assertEqual(from_email, 'noreply@todoapp')
		self.assertEqual(to_list, ['a@example.com'])

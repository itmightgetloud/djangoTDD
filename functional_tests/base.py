...
class FunctionalTest(StaticLiveServerTestCase):
	...
	def  wait_to_be_logged_out(self, email):
		...
		self.wait_for(lambda: self.browser.find_elements_by_tag_name('email'))
		#self.wait_for(self.browser.find_element_by_css_selector('.navbar')
		self.wait_for(lambda: self.browser.find_element_by_css_selector('.navbar'))
		navbar = self.browser.find_element_by_css_selector('.navbar')
